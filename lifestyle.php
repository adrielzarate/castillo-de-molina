<article id="lifestyle-content">
    <section class="intro">
        <img class="img-background" src="img/lifestyle.jpg" alt="">
        ...
        <div class="container">
            <div class="row">
                <div class="col-xs-12 col-sm-8 col-sm-offset-3">
                    <h3>Praesent congue erat at massa</h3>
                ...
                <div class="col-xs-12 col-sm-8 col-sm-offset-3">
                    <div class="row">
                        <div class="col-xs-12 col-sm-6">
                            <img class="img-responsive" src="img/lifestyle.jpg" alt="">
                        </div>
                        <div class="col-xs-12 col-sm-6">
                ...
                <div class="col-xs-12 col-sm-8 col-sm-offset-3 x3-top">
