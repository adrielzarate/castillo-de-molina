                    ...
                    <div class="col-lg-12">
                        <form role="form">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    <label>Texto 1</label>
                                    <textarea class="form-control" rows="3">Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor. Aenean massa. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus.</textarea>
                                </div>

                                <div class="form-group">
                                    <label>Título redes</label>
                                    <input class="form-control" value="Síguenos:" >
                                </div>

                                <div class="form-group">
                                    <label>Título campo Nombre</label>
                                    <input class="form-control" value="Nombre*" >
                                </div>

                                <div class="form-group">
                                    <label>Título campo Email</label>
                                    <input class="form-control" value="Email*" >
                                </div>

                                <div class="form-group">
                                    <label>Título campo Comentario </label>
                                    <input class="form-control" value="Comentario" >
                                </div>

                                <div class="form-group">
                                    <label>Botón Enviar mensaje</label>
                                    <input class="form-control" value="Enviar" >
                                </div>

                                <div class="form-group">
                                    <label>Texto campos obligatorios</label>
                                    <input class="form-control" value="* Campos obligatorios" >
                                </div>
