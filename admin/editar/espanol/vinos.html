                    ...
                    <div class="col-lg-12">
                        <div class="col-md-6">
                            ...
                            <div class="alert alert-info" role="alert">
                                <div class="row">
                                    <div class="col-sm-2"><a class="btn btn-primary text-right" href="editar-noticia.html">Cargar vino</a></div>
                                </div>
                            </div>
                            ...
                            <div class="alert alert-info" role="alert">
                                <div class="row">
                                    <div class="col-sm-10"><span  class="text-left">Nombre del vino</span></div>
