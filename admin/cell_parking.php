                        ...
                        <form role="form">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    <label>Título</label>
                                    <input class="form-control" value="Cell Parking" >
                                </div>

                                <div class="form-group">
                                    <label>Texto 1</label>
                                    <textarea class="form-control" rows="3">MILES DE PERSONAS EN EL MUNDO SE ESTÁN COMPROMETIENDO A DESCONECTARSE DE SUS SMARTPHONES, PARA CONECTARSE CON QUIENES LOS RODEAN.</textarea>
                                </div>

                                <div class="form-group">
                                    <label>Texto 2</label>
                                    <textarea class="form-control" rows="3">Están dispuestas a cambiar el chat por una buena conversación con sus amigos, a buscar la calidad en cada cosa y experiencia, a valorar su tiempo transformando cada instante en una oportunidad para desconectarse y disfrutar el aquí y el ahora.

Cell Parking es una iniciativa de Castillo de Molina, que invita a desconectarte y disfrutar de la realidad que está presente, y no a través de una pantalla. Una copa de vino no nace para ser consumida, sino degustada de principio a fin, así mismo como nuestras vidas que no pueden transcurrir en la vorágine sin que nos detengamos a gozar de cada instante que ella nos regala.</textarea>
                                </div>

                                <div class="form-group">
                                    <label>Título 2</label>
                                    <input class="form-control" value="CELL PARKING EN EL MUNDO" >
                                </div>

                                <div class="form-group">
                                    <label>Título 3</label>
                                    <input class="form-control" value="MILES DE PERSONAS EN EL MUNDO SE ESTÁN COMPROMETIENDO A DESCONECTARSE DE SUS SMARTPHONES, PARA CONECTARSE CON QUIENES LOS RODEAN.">
                                </div>
